...
class UserServiceTest {
    ...
    @Test
    @DisplayName("Should properly handle repository exceptions during user creation")
    ...
    @Test
    @DisplayName("Should handle case insensitive email search correctly")
    void findByEmail_WithDifferentCaseEmail_ShouldUseRepositoryAsIs() {
        // Given
        ...
        // Note: The service should not modify the email case, 
        // that responsibility should be handled at the repository/database level
    }
}
